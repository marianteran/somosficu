  ...
  return (
    ...
    <div className="bannerPrincipal">
      ...
      <div className="bannerPrincipalContenido">
        ...
        <h6 className="animate__animated animate__fadeInDown bannerPrincipalTitulo">NOSOTROS</h6>
        <h6 className="animate__animated animate__fadeInDown bannerPrincipalSubTitulo">Conoce a nuestro maravilloso equipo</h6>
        </div>
      </div>
      <Carousel
