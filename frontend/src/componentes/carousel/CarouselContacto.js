...
<div className="bannerPrincipalContenido">
    ...
    <div className="bannerPrincipalTexto">
        ...
        <h6 className="animate__animated animate__fadeInDown bannerPrincipalTitulo">CONTACTO</h6>
        <h6 className="animate__animated animate__fadeInDown bannerPrincipalSubTitulo">Para mas información contáctenos, y suscríbete</h6>
    </div>
</div>
<Carousel
