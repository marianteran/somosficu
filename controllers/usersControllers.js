        ...
        html: `
            <div style="width:300px; margin: auto; ">
                ...
                <div style="text-align: center; margin-top:20px">
                        ...
                        <a href=https://somosficu.org/api/verify/${uniqueText} style="width:100px; height:50px; padding: 10px; border-radius: 2rem; background:#096684; color: white; font-size: 15px; text-decoration: none; ">Click Here</a>
                </div>
...
const usersControllers = {
    ...
    verifyEmail: async (req, res) => {
        ...
        if (user) {
            ...
            await user.save();
            res.redirect("https://somosficu.org/signin");
        } else {
            res.json({
                success: false,
